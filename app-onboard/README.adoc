...
NOTE: OpenShift officially deprecates the usage of DeploymentConfigs in version 4.14 (see https://access.redhat.com/articles/7041372). To force `jkube` to use +"Deployments"+ instead of +"DeploymentConfigs"+ the 
`-Djkube.build.switchToDeployment=true` switch is used.
